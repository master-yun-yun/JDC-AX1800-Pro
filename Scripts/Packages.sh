...
#以上自定义源
#-------------------------------------2025.04.03测试---------------------------------------#
UPDATE_PACKAGE "kiddin9" "kiddin9/kwrt-packages" "main" "" "luci-app-store luci-app-vlmcsd luci-app-aliyundrive-webdav luci-app-clouddrive2 luci-app-sunpanel luci-app-openvpn-server luci-app-socat"
